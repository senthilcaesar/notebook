...
function getInitialForm(card) {
  ...
  return {
    title: card.title || "",
    note: card.note || "",
    attachmentsText: Array.isArray(card.attachments)
            ...
            <div className="modal-header">
              <div>
                ...
                <h2 id="card-modal-title">
                  {card ? "Update your note" : "Capture a new note"}
                </h2>
              </div>
              <button
                type="button"
            ...
            <div className="modal-body">
              ...
              >
                ...
                <span className="pin-toggle-copy">
                  <strong>
                    {form.pinned ? "Pinned to top" : "Pin this card"}
                  </strong>
                  <span>
                    {form.pinned
                      ? "This note will stay above regular cards."
                      : "Keep this note easy to find in your notebook."}
                  </span>
                </span>
              </button>
            </div>
